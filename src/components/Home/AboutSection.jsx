...
const contentData = [
  {
    ...
    link: "/about-us/dr-alicia-natalizio",
  },
  {
    ...
    link: "/about-us/dr-juliana-cotler",
  },
  {
      ...
      <div className="about-content-home">
        <div className="about-desktop">
          <div className="about-flex">
            <div className="about-text">
              ...
              <div className="about-bottom">
                ...
                <Link to={contentData[index].link}>
                  <button className="meet-doctor-home">
            ...
            <div
              className={`about-image fade ${fade ? "fade-in" : "fade-out"}`}
            >
        ...
        <div className="about-mobile">
          <h3 className="about-heading">About Us</h3>
          <h1 className="about-title">
            BOARD <br /> CERTIFIED <br /> EXPERTISE
          </h1>
          ...
          <Link to={contentData[index].link}>
            <button
              className={`meet-doctor-home fade ${fade ? "fade-in" : "fade-out"}`}
            >
              {contentData[index].button}
            </button>
          </Link>
