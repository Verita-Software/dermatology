...
const blogs = [
  {slug: "rosacea-understanding-causes",
    ...
    date: "March 3, 2025",
    content: "When it comes to answering the question, what is rosacea...",
    image: ImageAssets.blog1,
    details: {
      intro: "Rosacea is a common skin condition...",
      extraHeading: "Rosacea Treatment Options",
      points: [
        "Topical Medications prescribed by dermatologists",
        "Laser Therapy to reduce redness",
        "Lifestyle adjustments including diet"
      ],
      conclusion: "Consult a dermatologist for the best treatment."
    }
  },
  {
    id: 2,
    ...
    details: {
      intro: "Early-stage skin cancer can sometimes resemble a rash...",
      extraHeading: "Signs to Watch",
      points: [
        "Persistent itchy or bleeding spots",
        "Sudden change in size or color of moles",
        "Rashes that don’t respond to treatment"
      ],
