...
const serviceData = {
  ...
  Injectables: {
    main: "Injectables are substances administered into the body using a syringe and needle. They're commonly used in medicine and cosmetics.Here's a quick breakdown Our Approach to Injectables",
    sections: [
      {
        heading: "Our Approach to Injectables",
        content:
          "",
        items: [
          {
            ...
            content:
              "All injections are performed by certified professionals with advanced training.",
              hasBullet: true,
          },
          {
          ...
          },
          {
            ...
            content:
              "We use only FDA-approved injectables to ensure safety and effectiveness.",
              hasBullet: true,
          },
          {
            title: "Comfort & Care:",
            content:
              "We use gentle techniques and offer numbing options for a smooth, comfortable experience.",
              hasBullet: true,
          },
        ],
      },
      {
        heading: "Skin Rejuvenation Injectables ",
        content:
          "",
        items: [
          {
            title: "Skin Boosters:",
            content:
              " Ultra-hydrating injections that improve skin elasticity, tone, and texture.",
            hasBullet: true,
          },
          {
            title: "Biostimulators:",
            content:
              "Products like Sculptra® or Radiesse® that stimulate collagen production over time for long-lasting firming and smoothing.",
            hasBullet: true,
          },
          {
            title: "Mesotherapy:",
            content:
              "A customized cocktail of vitamins, antioxidants, and hyaluronic acid micro-injected to nourish and revitalize the skin.",
            hasBullet: true,
          },
        ],
      },
        ...
        items: [
          {
            ...
            content:
              "Our team consists of medically trained injectors with advanced knowledge of facial anatomy and years of experience in delivering safe, precise treatments.",
            hasBullet: true,
          },
          {
            title: "Natural-Looking Results",
            content:
              "We specialize in subtle enhancements that refresh your appearance without changing who you are. Our goal is always to help you look rested, radiant, and naturally confident.",
            hasBullet: true,
          },
          {
            title: "Tailored Treatment Plans",
            content:
              " No two faces are the same. That’s why we create customized injectable plans based on your unique features, skin type, and aesthetic goals.",
            hasBullet: true,
          },
        ],
      },
